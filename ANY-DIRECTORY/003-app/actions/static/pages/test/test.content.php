...
<div class="alternating">
	...
	<section class="cards icons portholes">
		...
		<div class="inner">
			<section>
				<picture>
					<source srcset="', BASEURL, 'assets/imgs/images/avatars/moe.webp" type="image/webp">
					<img
						src="', BASEURL, 'assets/imgs/images/avatars/moe.jpg"
						alt="Moe Howard"
						loading="lazy"
					>
				</picture>
				...
				<picture>
					<source srcset="', BASEURL, 'assets/imgs/images/avatars/larry.webp" type="image/webp">
					<img
						src="', BASEURL, 'assets/imgs/images/avatars/larry.jpg"
						alt="Larry Fine"
						loading="lazy"
					>
				</picture>
				...
				<picture>
					<source srcset="', BASEURL, 'assets/imgs/images/avatars/curly.webp" type="image/webp">
					<img
						src="', BASEURL, 'assets/imgs/images/avatars/curly.jpg"
						alt="Curly Howard"
						loading="lazy"
					>
				</picture>
				...
				<picture>
					<source srcset="', BASEURL, 'assets/imgs/images/avatars/shemp.webp" type="image/webp">
					<img
						src="', BASEURL, 'assets/imgs/images/avatars/shemp.jpg"
						alt="Shemp Howard"
						loading="lazy"
					>
				</picture>
				...
				<picture>
					<source srcset="', BASEURL, 'assets/imgs/images/avatars/joe.webp" type="image/webp">
						<img
							src="', BASEURL, 'assets/imgs/images/avatars/joe.jpg"
							alt="Joe DeRita"
							loading="lazy"
						>
					</picture>
	...
	<section class="cards icons landscape framed">
		...
		<div class="inner">
			<section>
				...
				<picture>
					<source srcset="', BASEURL, 'assets/imgs/images/avatars/joe2.webp" type="image/webp">
						<img
							src="', BASEURL, 'assets/imgs/images/avatars/joe2.jpg"
							alt="Joe DeRita"
							loading="lazy"
						>
					</picture>
	...
	<section class="stacks">
		...
		<div class="inner">
			<section>
				<div>
					<h3>
						<time datetime="2013-04-06T13:53">8 August 2020</time>,
	...
	<section class="stacks icons">
		...
		<p>
			...
			Stacks with assets/imgs/images/icons have a larger max-width so that we can retain the "flow width" on the paragraphs.
		</p><p>
